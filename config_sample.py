...
# Private TNPSC Group 4 study coach
TNPSC_OWNER_USER_ID = 0  # Defaults to OWNER_ID when left as 0
...
TNPSC_SOURCE_CHANNEL_ID = 0
TNPSC_SOURCE_CHANNEL_ENABLED = False
TNPSC_SOURCE_CHANNEL_AUTO_PROCESS = True
TNPSC_PYQ_DEFAULT_EXAM = "TNPSC Group 4"
TNPSC_IMPORTANCE_MIN_PYQS = 1
TNPSC_YOUTUBE_ENABLED = True
TNPSC_YOUTUBE_MAX_DURATION = 7200
YOUTUBE_COOKIES_FILE = ""
TNPSC_GDRIVE_ENABLED = True
TNPSC_AUTO_SCOUT_ENABLED = True
TNPSC_SCOUT_REQUIRE_APPROVAL = True
...
FILELION_API = ""
STREAMWISH_API = ""
VIKINGFILE_HASH = ""  # VikingFile account user hash; empty allows anonymous upload
VIKINGFILE_FOLDER = ""  # Optional folder path, for example Anime/Movies
EXCLUDED_EXTENSIONS = ""
